...
public class GDItemTags extends ItemTagsProvider {
    ...
    public GDItemTags(DataGenerator generator, BlockTagsProvider provider, @Nullable ExistingFileHelper existingFileHelper) {
        super(generator, provider, GloompersDelight.MOD_ID, existingFileHelper);
    }
